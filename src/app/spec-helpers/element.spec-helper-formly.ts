...
/**
 * Returns a selector for the id attribute with the given attribute value.
 *
...
/**
 * Finds an element inside the Component by the given id attribute.
 * Throws an error if no element was found.
 *
 * @param fixture Component fixture
 * @param testId Test id set by id
...
/**
 * Finds all elements with the given id attribute.
 *
 * @param fixture Component fixture
 * @param testId Test id set by id
 */
...
/**
 * Gets the text content of an element with the given id attribute.
 *
 * @param fixture Component fixture
 * @param testId Test id set by id
 */
...
/**
 * Expects that the element with the given id attribute
...
/**
 * Sets the value of a form field with the given id attribute.
 *
 * @param fixture Component fixture
 * @param testId Test id set by id
 * @param value Form field value
...
/**
 * Emulates a left click on the element with the given id attribute.
 *
 * @param fixture Component fixture
 * @param testId Test id set by id
 */
 ...
 * When finding other elements, use `findEl` / `findEls` and id attributes.
 *
